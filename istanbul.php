...
<ul>
    ...
    <li><a style="background-color:black; color:white;" href="adminpanel.html">Admin Panel</a></li>
</ul>
<br><br>

<h2>Now, you see newly elected mayors in Istanbul!</h2>
<br>
<label for="dis" style="text-align:left;">To view detailed results of your district:</label>
<form action="bakirkoy.php">
  <select name="dis" id="dis">
    <option value="name">select</option>
    <option value="name">Bakirkoy</option>
    <option value="name">Besiktas</option>
    <option value="name">Beykoz</option>
    <option value="name">Beyoglu</option>
    <option value="name">Eyup</option>
    <option value="name">Fatih</option>
    <option value="name">Gaziosmanpasa</option>
  </select>
